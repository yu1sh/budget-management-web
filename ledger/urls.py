...
urlpatterns = [
    ...
    path("credit-card-billing/", views.credit_card_billing, name="credit_card_billing"),
    path("credit-card-billing/<int:pk>/", views.credit_card_billing_detail, name="credit_card_billing_detail"),
    path("credit-card-billing/<int:pk>/export/", views.download_credit_card_billing_csv, name="credit_card_billing_export"),
    ...
    path("settings/sources/<int:pk>/delete/", views.source_delete, name="source_delete"),
